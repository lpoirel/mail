...
print 'Connecte a pop.gmail.com'
print pop.user('louis.poirel')
print pop.pass_(getpass.getpass())
lis=pop.list()

# On se place dans le dossier
chemin='/media/loulou/LOUIS_16GO/mailsd/junk'
chemin='/media/LOUIS_16GO/mailsd/junk'
reponse=raw_input('Dans quel dossier doit-on enregistrer les mails ?\n('+chemin+') ')
if reponse : chemin=reponse
print ' -> '+chemin
os.chdir(chemin)
